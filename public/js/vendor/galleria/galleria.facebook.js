...
Galleria.Facebook.prototype = {
    ...
    */
	...
	// Thank you @randomdave and @norbertFeron for your help diagnosing and solving: https://github.com/aiaio/galleria-facebook/issues/14
        var url = 'https://graph.facebook.com/' + params['album_id'] + '?callback=?' + '&fields=photos.limit('+this.options.max+').fields(images,source,picture,link,name)&access_token=232961117114486|O4f1M-2vSym49PbrSW5iSemzt0g';
